  ...
  return (
    <>
      ...
      <section className="bg-lm-indigo pt-20 overflow-hidden">
        <div className={container}>
          <div className="grid grid-cols-2 gap-12 items-center">
            ...
            {/* Image — flat bottom, rounded top, floats into next section */}
            <div className="flex items-center justify-center">
              <div
                className="w-full max-w-[440px] overflow-hidden border border-lm-lime/15 border-b-0"
                style={{
                  borderRadius: '20px 20px 0 0',
                  boxShadow: '0 -20px 60px rgba(163,230,53,0.12)',
                }}
              >
          ...
          <div className="grid grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-[0.96rem] text-lm-muted max-w-[500px] mb-10">
                You did not start a business to spend your whole day copying orders and chasing
                payments.
              </p>
                ...
                {[
                  {
                    ...
                    emoji: '📋',
                    title: 'Order chaos',
                    body: 'Customer sends a message. You reply. You note it somewhere. Then you forget. Then they ask again.',
                  },
                  {
                    hi: true,
                    emoji: '🌙',
                    title: 'Missed night sales',
                    body: 'A customer wanted to buy at 11pm. Nobody replied. By morning, they had found someone else.',
                  },
                  {
                    hi: false,
                    emoji: '💸',
                    title: 'Did they actually pay?',
                    body: 'They send a screenshot. You check your account. You wait. You release the goods. It bounces.',
                  },
                  {
                    hi: false,
                    emoji: '📢',
                    title: 'Restocked. Nobody knows.',
                    body: 'New stock arrived. You post a status. 20 people see it. Your other 300 customers have no idea.',
                  },
                ].map((card) => (
                  <div
                    key={card.title}
                    className={`bg-white border rounded-xl p-5 ${
                      card.hi ? 'border-lm-border border-t-[3px] border-t-lm-lime' : 'border-lm-border'
                    }`}
                  >
                    <span className="text-2xl mb-2.5 block">{card.emoji}</span>
                    <div className="font-poppins text-[0.88rem] font-bold text-lm-indigo mb-1.5">
                      {card.title}
                    </div>
      ...
      <section className="bg-white py-20" id="how">
              ...
              {[
                {
                  ...
                  body: 'Upload photos, set prices, connect your Paystack account. Takes about 5 minutes.',
                },
                {
                  n: '2',
                  title: 'Share your store link',
                  body: 'You get a unique link. Drop it in your WhatsApp status, Telegram channel, or Instagram bio.',
                },
                {
                  n: '3',
                  title: 'Get paid automatically',
                  body: 'Orders come in, payments are verified by Paystack, and you are notified. No manual checking.',
                },
              ].map((step) => (
                <div key={step.n} className="flex gap-5 items-start">
                  ...
                  <div>
                    <h3 className="font-poppins text-base font-bold text-lm-indigo mb-1.5">
                      {step.title}
                    </h3>
        ...
        {/* 4-taps strip — full bleed within the section */}
          ...
          <div className={container}>
            ...
            <div className="grid grid-cols-4 gap-4">
              {[
                ...
                <div
                  key={card.tap}
                  className={`rounded-[10px] p-[1.1rem] ${
                    card.final
                      ? 'bg-lm-lime border border-lm-lime'
                      : 'bg-white/5 border border-white/[0.08]'
                  }`}
                >
                  <div
                    className={`text-[0.72rem] font-bold tracking-[0.1em] uppercase mb-2 ${
                      card.final ? 'text-lm-indigo' : 'text-lm-lime'
                    }`}
                  >
                    {card.tap}
                  </div>
                  ...
                  <div
                    className={`font-poppins text-[0.85rem] font-bold mb-0.5 ${
                      card.final ? 'text-lm-indigo' : 'text-white'
                    }`}
                  >
                    {card.title}
                  </div>
                  <div
                    className={`text-[0.78rem] ${
                      card.final ? 'text-lm-indigo/70' : 'text-lm-muted-dark'
                    }`}
                  >
                    {card.sub}
                  </div>
        ...
        <div className={container}>
          ...
          <div className="grid grid-cols-3 gap-5">
            {[
              {
                icon: '🤖',
                title: '24/7 automated store',
                body: 'Your bot takes orders and answers product questions while you sleep, eat, or rest.',
              },
              {
                icon: '✓',
                title: 'Verified payments only',
                body: 'Paystack confirms every payment before your customer gets an order confirmation. No more fake alerts.',
              },
              {
                icon: '📦',
                title: 'Product catalogue',
                body: 'Add photos, prices, and descriptions. Customers browse it directly inside WhatsApp or Telegram.',
              },
              {
                icon: '📊',
                title: 'Sales dashboard',
                body: 'See every order, every payment, and every customer in one place. No more counting notebooks.',
              },
              {
                icon: '📢',
                title: 'Customer broadcasts',
                body: 'Restocked? New promo? Send a message to all your opted-in customers at once.',
              },
              {
                icon: '👥',
                title: 'Team access',
                body: 'Add sales reps who manage orders and customers without touching your payments or settings.',
              },
            ].map((feat) => (
              <div key={feat.title} className="bg-white border border-lm-border rounded-xl p-6">
                ...
                <div className="font-poppins text-[0.92rem] font-bold text-lm-indigo mb-1.5">
                  {feat.title}
                </div>
        ...
        <div className={container}>
          ...
          <div className="grid grid-cols-3 gap-5">
            ...
            <div className="border border-lm-border rounded-[14px] p-7">
              ...
              <div className="text-[0.84rem] text-gray-400 mb-5 pb-5 border-b border-gray-100">
                For new stores getting their first orders.
              </div>
              <ul className="flex flex-col gap-2.5 mb-6 list-none p-0">
                {['Bot store (Telegram)', 'Unlimited products', 'Paystack payments', 'Order notifications'].map(
                  (f) => (
                    <li key={f} className="text-[0.86rem] text-lm-muted flex items-center gap-2">
                      <span className="text-lm-lime font-bold text-[0.84rem]">✓</span>
                      {f}
                    </li>
                  )
                )}
            ...
            <div className="border-2 border-lm-lime rounded-[14px] p-7 relative">
              ...
              <div className="text-[0.84rem] text-gray-400 mb-5 pb-5 border-b border-gray-100">
                For busy stores scaling up sales.
              </div>
              <ul className="flex flex-col gap-2.5 mb-6 list-none p-0">
                {['Everything in Starter', 'Customer broadcasts', 'Sales analytics', '1 sales rep'].map(
                  (f) => (
                    <li key={f} className="text-[0.86rem] text-lm-muted flex items-center gap-2">
                      <span className="text-lm-lime font-bold text-[0.84rem]">✓</span>
                      {f}
            ...
            <div className="border border-lm-border rounded-[14px] p-7">
              ...
              <div className="text-[0.84rem] text-gray-400 mb-5 pb-5 border-b border-gray-100">
                For high-volume merchants who need it all.
              </div>
              <ul className="flex flex-col gap-2.5 mb-6 list-none p-0">
                {[
                ...
                {[
                  {
                    ...
                    body: 'Every transaction goes through Paystack, a CBN-licensed payment processor trusted by thousands of Nigerian businesses.',
                  },
                  {
                    icon: '🇳🇬',
                    title: 'NDPR Compliant',
                    body: 'Your customer data is stored and handled in line with the Nigeria Data Protection Regulation.',
                  },
                  {
                    icon: '📋',
                    title: 'CAC Registered',
                    body: 'Lameda is a registered Nigerian business. We are not going anywhere.',
                  },
                ].map((card) => (
                  <div
                    key={card.title}
                    className="bg-white border border-lm-border rounded-xl p-5 flex gap-4 items-start"
                  >
                    <div className="text-[1.3rem] min-w-[2rem]">{card.icon}</div>
                    <div>
                      <div className="font-poppins text-[0.9rem] font-bold text-lm-indigo mb-1">
                        {card.title}
                      </div>
            ...
            <div className="flex gap-6 flex-wrap">
              {[
                ...
                <a
                  key={link.label}
                  href={link.href}
                  className="text-[0.86rem] text-lm-muted-dark no-underline hover:text-white transition-colors"
                >
                  {link.label}
                </a>
              ))}
